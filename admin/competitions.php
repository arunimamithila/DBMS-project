  ...
  <head>
    ...
    <title>uniCircle Competitions</title>
      ...
      <div class="container">
        ...
        <div class="heading">
          ...
          <div class="discription">
            <h3>Competitions</h3>
            <p>Grow your skills by competing with your piers
              <br>and enhance your teamwork
            </p>
          </div>

          <div class="pic">
            <img src="../assets/image/com.png" alt="">
          </div>
        </div>

        <div class="button btn btn-primary">
          <a class="add_link" href="#">Host a Competition </a>
        </div>
            ...
            <div class="card-container">
              <div class="comp-card">
                <div class="comp-img">
                  ...
                  <img class="compimg" src="../assets/image/aicomp.jpg" alt="">
                </div>

                <div class="comp-name">
                  <h6>AI Mathematical Olympiad</h6>

                </div>

                <div class="team">team joind
              ...
              <div class="comp-card">
                <div class="comp-img ">
                  ...
                  <img class="compimg" src="../assets/image/data.jpg" alt="">
                </div>

                <div class="comp-name">
                  <h6>Data Science Essay writing</h6>
